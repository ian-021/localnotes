...
export const CMDS = [['q', 'back / close'], ['new book <title>', 'creates it · "Title - Author" sets both'], ['quote', 'new quote here'], ['def <word>', 'new vocab word · definition on line 2'], ['page <n>', 'set page of quote'], ['tag #name', 'tag this book'], ['go #name', 'open tag view'], ['vocab', 'all words across books'], ['ai', 'look up word with openai'], ['author <name>', 'set author'], ['theme dark', ''], ['theme light', ''], ['set nu', 'toggle line numbers'], ['help', 'keys'], ['w', 'write archive now · editing: write the buffer'], ['reload', 'reload from the archive folder'], ['wq', 'editing: write & close'], ['q!', 'editing: discard & close'], ['git <args>', 'run git in the archive · result in the status bar'], ['commit <message>', 'git add -A, commit, push'], ['push', 'git push'], ['pull', 'git pull, then reload'], ['status', 'git status'], ['log', 'git log, last 20'], ['reset', 'clear all data']];
export const HELP = [['h j k l', 'move · h back / l open · tree: l unfold · h fold'], ['Enter', 'open · leaf: edit'], ['i  c', 'edit in the buffer (normal mode)'], ['a  A  I', 'edit, insert at end · at start'], ['o', 'new item, insert mode · thread: sibling thought'], ['a', 'thread: reply to the thought under the cursor'], ['buffer', 'i a I A o O · h j k l w b e 0 ^ $ gg G · x dd dw cw D C S J'], ['buffer', 'text objects iw aw iW ip i( i[ i" … with v c d y'], ['buffer', 'v V visual (t tags the selection) · yy p u C-r · :w :wq :q :q!'], ['v', 'list: visual line'], ['dd  u', 'delete · undo'], ['yy  p', 'yank · paste as new item'], ['⌘c  ⌘v', 'copy line · paste'], ['gg  G', 'top · bottom'], ['/', 'search'], [':', 'command'], ['gx', 'follow first [link] in line'], ['r', 'word view: ask openai again'], [':git  :commit', 'git in the archive · add + commit + push'], ['↑ ↓ ← →', 'command line: history · move'], ['[word]', 'tag · [some words](tag) tags a span'], ['C-w  C-u', 'insert: delete word / to start'], ['C-h  C-l', 'focus sidebar · main'], ['\\b  ␣ee', 'toggle sidebar'], ['Esc', 'normal']];
